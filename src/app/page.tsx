      ...
      <header className="py-8 border-b border-gray-800 flex flex-col md:flex-row items-start md:items-center justify-between gap-4">
        <div>
          ...
          <p className="text-gray-400 text-sm mt-1">
            Stealth Intelligence Gift Exchange Network for Families & Friends.
          </p>
        </div>

        <div className="flex items-center gap-3">
          <div className="glass-panel px-4 py-2 rounded-lg text-right">
            <div className="text-xs text-gray-400 font-mono">DEPLOYMENT MODEL</div>
            <div className="text-sm font-semibold text-emerald-400 flex items-center gap-1">
              <span>Docker Containerized</span>
              <span className="text-xs bg-gray-800 text-gray-300 px-1.5 py-0.5 rounded">SaaS Ready</span>
            </div>
          </div>
        </div>
      </header>
        ...
        <div className="lg:col-span-1 space-y-6">
          <div className="glass-panel p-6 rounded-xl border border-emerald-500/20 ops-glow-emerald">
            <div className="flex items-center justify-between">
              <span className="text-xs font-mono text-emerald-400 uppercase tracking-wider">ACTIVE MISSION</span>
