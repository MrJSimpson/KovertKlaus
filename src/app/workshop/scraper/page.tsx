...
export default function WorkshopScraperBench() {
  ...
  const presetUrls = [
    ...
    { label: 'Invalid Domain (Failover Test)', url: 'https://thisdomainshouldnotexist12345.org' },
  ];
    ...
    <div className="space-y-6 pb-12">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div className="lg:col-span-1 space-y-6">
          ...
          <div className="p-6 rounded-2xl border-2 bg-slate-900 border-sky-500/40">
              ...
              <div className="flex flex-col gap-2">
                {presetUrls.map((preset, idx) => (
                  <button
                    ...
                    className="text-left bg-slate-950 hover:bg-slate-800 p-2.5 rounded-lg border border-slate-800 text-xs font-mono transition-colors flex items-center justify-between cursor-pointer"
                  >
          ...
          <div className="p-6 rounded-2xl border-2 bg-slate-900 border-slate-800 text-xs font-mono space-y-3">
        ...
        <div className="lg:col-span-2 space-y-6">
          ...
          <div className="p-6 rounded-2xl border-2 bg-slate-900 border-sky-500/30">
