    ...
    <div className="min-h-screen pb-16 px-4 sm:px-8 max-w-7xl mx-auto bg-slate-950 text-slate-100">
        ...
        <div>
          <div className="flex items-center gap-3">
            ...
            <span className="text-xs px-2 py-0.5 rounded font-mono uppercase bg-emerald-950 text-emerald-300 border border-emerald-500/30">
              TEST BENCH // TARGET ALGORITHM & SWAP LAB
            </span>
          </div>
          <h1 className="text-3xl md:text-4xl font-extrabold tracking-tight mt-2 text-white flex items-center gap-2">
            ...
            <span className="text-emerald-400 font-mono text-sm border border-emerald-500/30 px-2 py-1 rounded bg-emerald-950/40">
              DERANGEMENT & SWAP BENCH
            </span>
          </h1>
          <p className="text-gray-400 text-sm mt-1">
            Interactive Test Harness for Sattolo Derangements, 100% Bidirectional Exclusion Filters ($A \iff B$), and 2-Way Target Cascade Swaps.
          </p>
        </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 mt-8">
        ...
        <div className="lg:col-span-1 space-y-6">
          ...
          <div className="p-6 rounded-xl border-2 bg-slate-900 border-emerald-500/30 shadow-xl">
            ...
            <h2 className="text-xl font-bold text-white mt-3">Simpson Family Stealth Ops</h2>
            ...
            <div className="mt-6">
              <button 
                ...
                className="w-full bg-emerald-600 hover:bg-emerald-500 text-white font-bold py-2.5 px-4 rounded-xl transition-all shadow-lg shadow-emerald-950/40 text-sm cursor-pointer flex items-center justify-center gap-2"
              >
          ...
          <div className="p-6 rounded-xl border-2 bg-slate-900 border-purple-500/30 space-y-4">
            <div className="flex items-center justify-between">
              <h3 className="text-sm font-mono font-bold text-purple-300 uppercase tracking-wider flex items-center gap-2">
        ...
        <div className="lg:col-span-2 space-y-6">
          ...
          <div className="p-6 rounded-xl border-2 bg-slate-900 border-slate-800">
            ...
            <form onSubmit={addAgent} className="grid grid-cols-1 sm:grid-cols-3 gap-3 mb-6">
              ...
              <button
                type="submit"
                className="bg-slate-800 hover:bg-slate-700 text-emerald-400 font-mono font-medium rounded-lg px-4 py-2 text-sm transition-colors cursor-pointer border border-emerald-500/20"
              >
                + Enlist Agent
              </button>
            </form>
          ...
          <div className="p-6 rounded-xl border-2 bg-slate-900 border-emerald-500/30 space-y-6">
